...
namespace guitard {
  /**
   * A control which can host child controls and scroll them along the y axis
   * Since iplug doesn't support multi param controls it will not be informed about changes on any of its
   * children
   */
