...
Source: "..\build-win\GuitarD.vst3\PlugIn.ico"; DestDir: "{cf64}\VST3\GuitarD.vst3\"; Check: Is64BitInstallMode; Components:vst3_64; Flags: overwritereadonly ignoreversion; Attribs: hidden system;
...
Source: "..\manual\GuitarD manual.pdf"; DestDir: "{app}"
Source: "changelog.txt"; DestDir: "{app}"
Source: "readme-win.rtf"; DestDir: "{app}"; DestName: "readme.rtf"; Flags: isreadme

[Icons]
Name: "{group}\GuitarD"; Filename: "{app}\GuitarD.exe"
